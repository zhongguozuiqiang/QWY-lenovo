!(function(name,factory){
    ...
    return {
        init:function(opts){
            ...
            try{
            if(document.URL.indexOf('lenovovip')!=-1||document.URL.indexOf('vip')!=-1||document.URL.indexOf('motob2r')!=-1){
                    if(passport&& (typeof  passport.cookie.groupCode!='undefined'))
                        url = '/cache/query?m=hmget&k=product_price'+passport.cookie.groupCode+'&f='
            }
            }catch (e){
